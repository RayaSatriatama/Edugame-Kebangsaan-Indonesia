...
import com.mycompany.edun.login_menu;
 ...
 */
public class sukses_quiz extends javax.swing.JFrame {
    ...
    public sukses_quiz() {
        ...
        try {
           ...
           text_skorKamu.setFont(font_button);
           button_try.setFont(font_button);
           button_next.setFont(font_button);
           
           Font font_24 = Font.createFont(Font.TRUETYPE_FONT, fontBlack).deriveFont(20f);
           skor_pengguna.setFont(font_24);
           text_PTS.setFont(font_24);
    ...
    public sukses_quiz (String marks) {
        initComponents();
        String marks1= marks;
        skor_pengguna.setText(marks1);
    }
    ...
    private void initComponents() {
        ...
        skor_pengguna.setText("[SKOR]");
        getContentPane().add(skor_pengguna, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 710, -1, -1));

        text_PTS.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        text_PTS.setText("PTS");
        getContentPane().add(text_PTS, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 710, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sukses_quiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sukses_quiz().setVisible(true);
            }
        });
    }
