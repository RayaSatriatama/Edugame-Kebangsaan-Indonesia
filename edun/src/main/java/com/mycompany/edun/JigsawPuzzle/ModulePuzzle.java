...
import com.mycompany.edun.ImagePuzzleFrame;
 ...
 * @author ivanbesti
 */
public class ModulePuzzle extends javax.swing.JFrame {
public String inputName;
    ...
    public ModulePuzzle(String username1) {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT materi FROM modul WHERE id = 1;");
    ...
    private void button_playActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_playActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        new ImagePuzzleFrame(inputName).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModulePuzzle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModulePuzzle().setVisible(true);
            }
        });
    }
