 ...
 */
public class sukses_crossword extends javax.swing.JFrame {

    /**
     * Creates new form sukses
     */
    public sukses_crossword() {
        initComponents();
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sukses_crossword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sukses_crossword().setVisible(true);
            }
        });
    }
